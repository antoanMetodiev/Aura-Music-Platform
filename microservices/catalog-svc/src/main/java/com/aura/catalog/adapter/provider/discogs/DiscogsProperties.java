 ...
 * without; asks for a descriptive User-Agent. Here it supplies an artist's outside links (site,
 * socials, Wikipedia) and a short profile text.
 */
@Validated
...
public record DiscogsProperties(
        ...
        /** Minimum spacing between two Discogs calls from this process. */
